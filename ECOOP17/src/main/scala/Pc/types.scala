...
case Mov1BC => ((Out[C_Pc_Pa_3,Mov1CA] >>: Loop[RecPc_1])|(Out[C_Pc_Pa_3,Mov2CA] >>: Loop[RecPc_1])) 
} 
...
C_Pc_Pa_3 <: OutChannel[Mov1CA|Mov2CA]] = 
 In[C_Pc_Q_1, PlayC, (x:PlayC) => Rec[RecPc_1, In[C_Pc_Pb_1, InfoBC, (x:InfoBC) => Out[C_Pc_Pa_1,InfoCA] >>: In[C_Pc_Pb_2, InfoAB, (x:InfoAB) => In[C_Pc_Pa_2, Mov2AC|Mov1BC, (X_2:Mov2AC|Mov1BC) => Pc_2[X_2.type,C_Pc_Pa_3]]]]]] 
