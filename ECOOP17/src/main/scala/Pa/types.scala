...
C_Pa_Pc_3 <: OutChannel[Mov2AC]] = 
 In[C_Pa_Q_1, PlayA, (x:PlayA) => Rec[RecPa_1, In[C_Pa_Pc_1, InfoCA, (x:InfoCA) => ((Out[C_Pa_Pb_1,Mov1AB] >>: Out[C_Pa_Pc_2,Mov1BC] >>: In[C_Pa_Pc_4, Mov1CA|Mov2CA, (X_2:Mov1CA|Mov2CA) => Pa_2[X_2.type]])|(Out[C_Pa_Pb_1,Mov2AB] >>: Out[C_Pa_Pc_3,Mov2AC] >>: In[C_Pa_Pc_4, Mov1CA|Mov2CA, (X_3:Mov1CA|Mov2CA) => Pa_3[X_3.type]]))]]] 
